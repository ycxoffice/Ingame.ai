...
function CompanyData() {
  ...
  const financialInfoGroup = ["Funding Raised", "Revenue", "Company Valuation"];
  const gamingTechGroup = [
    "Game Titles Developed",
    "Game Engine Used",
    "AI Technology Used in Games",
    "AI Role in Gaming",
    "Cloud Gaming Support",
    "Game Monetization Model",
    "Player Analytics & AI Usage",
    "VR/AR Integration",
    "eSports Involvement",
    "Blockchain & NFT Integration",
    "Gaming AI Research & Patents",
    "Multiplayer AI Capabilities",
  ];
